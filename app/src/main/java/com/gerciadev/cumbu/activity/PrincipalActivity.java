...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void recuperarResumo(){
        ...
        valueEventListenerUsuario = usuarioRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                moeda = usuario.getCurrency();
                resumoUsuario = receitaTotal - despesaTotal;

                DecimalFormat decimalFormat = new DecimalFormat("0.##");
                String resultadoFormatado = decimalFormat.format( resumoUsuario );

                textoSaudacao.setText(getResources().getString(R.string.suada) + " "  + usuario.getNome() );
                textoSaldo.setText( " " + resultadoFormatado +" "+moeda );
    ...
    public void configuraCalendarView(){
        ...
        CharSequence meses[] = getResources().getStringArray(R.array.meses);
